...
describe("<Header />", () => {
  it("renders the basic <Header /> with a background", () => {
    const { container, getByText, getByTestId } = render(
      <Header>
        <Header.Frame>
          <Header.Logo src="/logo.svg" alt="MobFlix" />
  ...
  it("renders the full <Header> with a background", () => {
    const { container, getByText, getByTestId } = render(
      <Header src="joker1" dontShowOnSmallViewPort>
        <Header.Frame>
          <Header.Group>
            <Header.Logo src="/images/logo.svg" alt="MobFlix" />
          ...
          <Header.Group>
            ...
            <Header.Profile>
              <Header.Picture src="/images/bahmi.png" />
              <Header.Dropdown>
                <Header.Group>
                  <Header.Picture src="/images/bahmi.png" />
                  <Header.TextLink>Bahmi</Header.TextLink>
                </Header.Group>
                <Header.Group>
    ...
    expect(getByText("Bahmi")).toBeTruthy();
